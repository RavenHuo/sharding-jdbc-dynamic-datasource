package com.raven.dynamic.datasource.datasource.master2slave;
...
@Slf4j
public class DynamicDataSourceMasterSalveLoadingAutoConfiguration extends AbstractDynamicDataSource {
     ...
     */
    @Override
    public List<DynamicDataSourceProperties> loadDataSourceProperties(List<?> dataSourceProperties) {
        MasterSlaveDataSourceProperties masterSlaveDataSourceProperties = (MasterSlaveDataSourceProperties) dataSourceProperties.get(0);
